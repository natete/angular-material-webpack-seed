...
/* @ngInject */
function LangsService($translate, $log, $rootScope, LOCALES, tmhDynamicLocale) {
  'use strict';
  var service = this;
  // Getting the locales from LOCALES constant (the available locales).
  var localesObj = LOCALES;
